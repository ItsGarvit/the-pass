...
export function MentorLogin({ onBack, onSwitchToSignup }: MentorLoginProps) {
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-5 h-5 rounded border-2 border-gray-900 dark:border-gray-100 text-purple-600 focus:ring-2 focus:ring-purple-300"
                />
